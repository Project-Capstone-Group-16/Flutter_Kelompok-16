  ...
  Future <void> fetchData()async{
    try{
      ...
      if(response.statusCode==200){
        ...
        locations.forEach((x) => locationDescription[x.lokasiLoker] = x.description);
      } else{
...
class Lokasi {
  ...
  Lokasi ({required this.lokasiLoker, required this.image, required this.alamat, required this.description});
